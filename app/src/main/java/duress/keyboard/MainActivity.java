...
public class MainActivity extends Activity {
	...
	"By the way, this application wipes the FRP (if you didn't disable it in additional options). Everything that is written next is written as an extra precaution, for example, for the case if it was auto-wipe or if the system didn't allow to wipe the FRP.\n\n" +
